(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-components-todo-list-todo-list-module"],{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css\">\n<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js\"></script>\n<script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js\"></script> -->\n<div class=\"container\">\n    <span>\n        <h2>Todo List</h2>\n    </span>\n    <span>\n        <button type=\"btn\" class=\"btn\" (click)=\"addNewTodo()\">Add New ToDo</button>\n    </span>\n    <table class=\"table\">\n        <thead>\n            <tr>\n                <th> Name </th>\n                <th> Phone Number </th>\n                <th> Email Id </th>\n                <th>Action</th>\n            </tr>\n        </thead>\n        <tbody>\n            <tr *ngFor=\"let todo of todos; let idx = index\"\n                [style.background-color]=\"todo.isSelected ? 'antiquewhite': ''\">\n                <td>\n                    <span>\n                        {{todo.firstName+' '+todo.middleName+' '+todo.lastName}}\n                    </span>\n                    <!-- <span *ngIf=\"todo.isSelected\">{{todo.isSelected}}</span> -->\n                </td>\n                <td>{{todo.phone}}</td>\n                <td>{{todo.email}}</td>\n                <td>\n                    <button type=\"btn\" class=\"btn\" (click)=\"viewTodo(todo, idx) ; open(mymodal);\">View</button>\n                    &nbsp;\n                    <button type=\"btn\" class=\"btn\" (click)=\"openPopup(todo, idx)\">View Popup</button>\n                    &nbsp;\n                    <button type=\"btn\" class=\"btn\" (click)=\"editTodo(todo)\">Edit</button>\n                    &nbsp;\n                    <button type=\"btn\" class=\"btn\" (click)=\"deleteTodo(todo.id)\">Delete</button>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n    <div *ngIf=\"todoViewDetail && todoViewDetail.id\">\n        <p>Selected Todo-{{todoViewDetail.firstName}}</p>\n        <div>\n            <app-todo-view [todoDetail]=\"todoViewDetail\" [itemIndex]=\"itemIndex\" (itemSelected)=\"manageSelectedTodo($event, itemIndex)\"></app-todo-view>\n        </div>\n    </div>\n</div>\n\n\n<button type=\"btn\" class=\"btn\" (click)=\"isValid ? isValid = false : isValid = true\">Change Content</button>\n<br>\n<div *ngIf=\"isValid; else elseBlock\">Content to render when condition is true.</div>\n<ng-template #elseBlock>Content to render when condition is false.</ng-template>\n\n<br>--<br>\n\n\n<div *ngIf=\"isValid; then thenTemplateName else elseTemplateName\">\n    Here is never showing\n</div>\n\n<ng-template #thenTemplateName>\n    If isValid is true\n</ng-template>\n\n<ng-template #elseTemplateName>\n    If isValid is false\n</ng-template>\n\n\n\n\n<h1>Angular 8 Bootstrap Modal Popup Example</h1>\n   \n<button class=\"btn btn-lg btn-outline-primary\" (click)=\"open(mymodal)\">Open My Modal</button>\n   \n<ng-template #mymodal let-modal>\n  <div class=\"modal-header\">\n    <h4 class=\"modal-title\" id=\"modal-basic-title\">Bootstrap Modal</h4>\n    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.dismiss('Cross click')\">\n      <span aria-hidden=\"true\">×</span>\n    </button>\n  </div>\n  <div class=\"modal-body\">\n    This is example from ItSolutionStuff.com\n    <app-todo-view [todoDetail]=\"todoViewDetail\" [itemIndex]=\"itemIndex\" (itemSelected)=\"manageSelectedTodo($event, itemIndex)\"></app-todo-view>\n  </div>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-outline-dark\" (click)=\"modal.close('Save click')\">Ok</button>\n  </div>\n</ng-template>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/todo-view/todo-view.component.html":
/*!*****************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/todo-view/todo-view.component.html ***!
  \*****************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>todo-view works!</p>\n<div class=\"col-lg-12\">\n    INPUT:&nbsp;<input type=\"text\" class=\"form-control\" #firstName=\"ngModel\" name=\"firstName\" [(ngModel)]=\"todoDetail.firstName\" placeholder=\"Enter First Name\" required />\n    ID: {{todoDetail.id}}<br>\n    Name: {{todoDetail.firstName+' '+todoDetail.middleName+' '+todoDetail.lastName}}<br>\n    Phone: {{todoDetail.phone}}<br>\n    Email: {{todoDetail.email}}<br>\n    <button type=\"btn\" class=\"btn\" (click)=\"selectForClass(todoDetail, itemIndex)\">Select</button>\n</div>\n");
...
const routes = [
    { path: '', component: _todo_list_component__WEBPACK_IMPORTED_MODULE_3__["TodoListComponent"] }
];
let TodoListRoutingModule = class TodoListRoutingModule {
};
TodoListRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let TodoListComponent = class TodoListComponent {
    constructor(router, todoService, modalService) {
        this.router = router;
...
TodoListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./todo-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/todo-list/todo-list.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./todo-list.component.css */ "./src/app/components/todo-list/todo-list.component.css")).default]
    })
], TodoListComponent);
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _todo_list_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todo-list-routing.module */ "./src/app/components/todo-list/todo-list-routing.module.ts");
...
/* harmony import */ var _todo_view_todo_view_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../todo-view/todo-view.component */ "./src/app/components/todo-view/todo-view.component.ts");
...
TodoListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_todo_list_component__WEBPACK_IMPORTED_MODULE_5__["TodoListComponent"], _todo_view_todo_view_component__WEBPACK_IMPORTED_MODULE_6__["TodoViewComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _todo_list_routing_module__WEBPACK_IMPORTED_MODULE_4__["TodoListRoutingModule"],
...
/***/ "./src/app/components/todo-view/todo-view.component.css":
/*!**************************************************************!*\
  !*** ./src/app/components/todo-view/todo-view.component.css ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdG9kby12aWV3L3RvZG8tdmlldy5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/components/todo-view/todo-view.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/components/todo-view/todo-view.component.ts ***!
  \*************************************************************/
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TodoViewComponent.prototype, "todoDetail", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TodoViewComponent.prototype, "itemIndex", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], TodoViewComponent.prototype, "itemSelected", void 0);
TodoViewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-todo-view',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./todo-view.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/todo-view/todo-view.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./todo-view.component.css */ "./src/app/components/todo-view/todo-view.component.css")).default]
    })
], TodoViewComponent);
...
//# sourceMappingURL=app-components-todo-list-todo-list-module.js.map